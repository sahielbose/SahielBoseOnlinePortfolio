...
const DATA = {
  name: "Sahiel Bose",
  tagline: "Statistics & Data Science at UCLA. I build AI systems that reason, decide, and ship, from multi-agent LLM pipelines to neurotech devices.",
  email: "sahielbose@gmail.com",
  phone: "(925) 871-8844",
  github: "github.com/sahielbose",
  linkedin: "linkedin.com/in/sahiel-bose",
  about: [
    "I'm a founder, researcher, and engineer working at the intersection of machine learning and real-world systems.",
    "Currently co-founding Optivia, interning at ThinkNeuro, and researching reasoning in LLMs at UC Santa Cruz's AIEA Lab, alongside a GNN project at UC Riverside.",
  ],
  experience: [
    {
      company: "Optivia",
      ...
      <div className="topnav-inner">
        <a href="#intro" className="logo" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
          ...
          <span className="logo-text">
            ...
            <span className="logo-role mono">Portfolio</span>
          </span>
        </a>
      ...
      <div className="hero-content">
        ...
        <Reveal delay={0.4} className="hero-stats">
          ...
          <div className="hero-stat">
            ...
            <div className="hero-stat-lbl mono">stats & data science · '30</div>
          </div>
          <div className="hero-stat">
          ...
          <div className="hero-stat">
            <div className="hero-stat-num">2<span className="plus">nd</span></div>
            <div className="hero-stat-lbl mono">ACSEF · AI/ASL</div>
          </div>
        </Reveal>
      </div>
          ...
          <div className="ucla-body">
            <div className="ucla-degree-row">
              <div>
                ...
                <h3>B.S. Statistics &amp; Data Science</h3>
              </div>
  ...
  return (
    <section id="contact" className="section contact">
      ...
      <div className="megafoot">
        <div className="megafoot-name">
          SAHIEL · <span>BOSE</span>
        </div>
